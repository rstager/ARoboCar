...
unrealRootPath=/home/keras/ue4/UnrealEngine
ARoboCarRootPath=/home/keras/Documents/Unreal Projects/ARoboCar

gameProjectFile=/home/keras/Documents/Unreal Projects/ARoboCar/ARoboCar.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(ARoboCarSource.pri)
include(ARoboCarHeader.pri)
include(ARoboCarConfig.pri)
include(ARoboCarIncludes.pri)
include(ARoboCarDefines.pri)
...
ARoboCar-Linux-Debug.commands = $$build ARoboCar Linux Debug  -project="\"$$gameProjectFile\"" $$args
ARoboCar-Linux-DebugGame.commands = $$build ARoboCar Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ARoboCar-Linux-Shipping.commands = $$build ARoboCar Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ARoboCar-Linux-Test.commands = $$build ARoboCar Linux Test  -project="\"$$gameProjectFile\"" $$args
ARoboCar.commands = $$build ARoboCar Linux Development  -project="\"$$gameProjectFile\"" $$args

ARoboCarEditor-Linux-Debug.commands = $$build ARoboCarEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ARoboCarEditor-Linux-DebugGame.commands = $$build ARoboCarEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ARoboCarEditor-Linux-Shipping.commands = $$build ARoboCarEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ARoboCarEditor-Linux-Test.commands = $$build ARoboCarEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ARoboCarEditor.commands = $$build ARoboCarEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	ARoboCar-Linux-Debug \
	ARoboCar-Linux-DebugGame \
	ARoboCar-Linux-Shipping \
	ARoboCar-Linux-Test \
	ARoboCar \
	ARoboCarEditor-Linux-Debug \
	ARoboCarEditor-Linux-DebugGame \
	ARoboCarEditor-Linux-Shipping \
	ARoboCarEditor-Linux-Test \
	ARoboCarEditor \
